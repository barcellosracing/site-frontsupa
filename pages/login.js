...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex justify-center bg-gray-950 px-4">
      <div className="flex flex-col justify-start mt-24 sm:mt-32 w-full max-w-sm">
        <div className="bg-gray-900 p-10 rounded-3xl shadow-2xl transform transition-transform hover:scale-[1.02]">
